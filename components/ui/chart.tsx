...
function ChartTooltipContent({
  ...
  // EARLY RETURN is now safely evaluated before any heavy JSX logic
  ...
  // Instantiate the memoized component here so it can be reused in the two places below
  const tooltipLabelElement = (
    <ChartTooltipLabel
      ...
      label={label}
      labelFormatter={
        labelFormatter as ChartTooltipLabelProps['labelFormatter']
      }
    ...
    >
      ...
      <div className='grid gap-1.5'>
        {payload.reduce((acc, item) => {
          ...
          const filteredIndex = acc.length;
